...
\begin{table}[!h]
  ...
  \begin{tabular}{||l|p{5cm}|p{9cm}||}\hline
      ...
      \ontologiaa  & \aan Ontology from the Brazilian name Ontologia do \aan & small, simple and linked entirely linked to upper ontologies (classes and properties) \\ \hline
