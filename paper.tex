...
\author{Flor Karina Mamani Amanqui}
  ...
  \altaffiliation{Instituto de Ci\^encias Matem\'aticas e de Computa\c{c}\~ao (ICMC/USP)}%Lines break automatically or can be forced with \\
...
\keywords{OWL, semantic web, linked data, electronic democracy, participatory democracy, social participation, social systems}%Use showkeys class option if keyword
\maketitle
