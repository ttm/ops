...
\begin{itemize}
    ...
    \item Restriction: {\tt Problem generatesCause some Cause}.
\end{itemize}
...
These were changed to the standard ``some'' existential restriction in preliminary \ops\ and were completely removed afterwards, as a way to avoid making \ops\ usage rigid and a more complicated.
...
\begin{figure*}[H]
    ...
    \caption{A diagram representation of a general public consultation. Further context of this image is in Appendix~\ref{ap:public}.}
    \label{fig:consult}
\end{figure*}
